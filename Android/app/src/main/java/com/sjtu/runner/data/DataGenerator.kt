...
//=======
        val randomPaceMinPerKm = 4.0 + (Math.random() * 2.0) // 生成4.0到6.0之间的随机数
        val totalDurationSec = (randomPaceMinPerKm * 60.0 * targetDistanceM / 1000.0).roundToInt()
//>>>>>>> 17ff54075cb376b5a577afb6d94899a81c14d682
