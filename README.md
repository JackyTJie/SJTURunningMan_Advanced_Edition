...
## HarmonyOS NEXT 端使用指南

> 未特别说明的内容与安卓端一致

### 1. 安装 HAP 包

> 强烈建议提前完成华为账号的开发者认证，以延长调试证书有效期！

1. 下载 HAP 文件
2. 手机进入设置->关于本机->点击软件版本7次并重启启用开发者选项，进入设置->系统->开发者选项->无线调试开启，记录IP与端口信息
3. PC端与手机连接相同网络，下载[小白调试助手](https://github.com/likuai2010/auto-installer)并运行，按软件内指引配置安装即可

### 2. 登录流程

进入账号一级页面，点击**JAccount 账号**即可跳转登录页面，注意鸿蒙端无法拉起交我办快捷登录
